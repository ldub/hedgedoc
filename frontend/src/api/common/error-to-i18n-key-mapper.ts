...
export class ErrorToI18nKeyMapper {
  ...
  public withBackendErrorName(name: string, i18nKey: string): this {
    if (this.foundI18nKey === undefined && this.apiError instanceof ApiError && this.apiError.apiErrorName === name) {
      this.foundI18nKey = i18nKey
    }
    return this
  }
  ...
  public getFoundI18nKey(fallback?: string): typeof fallback {
