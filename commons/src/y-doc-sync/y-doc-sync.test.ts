 ...
 */
import { InMemoryConnectionMessageTransporter } from '../message-transporters/in-memory-connection-message-transporter.js'
...
describe('message transporter', () => {
  it('server client communication', async () => {
    ...
    docServer.on('update', (update: Uint8Array, origin: unknown) => {
      const message: Message<MessageType.DOCUMENT_UPDATE> = {
